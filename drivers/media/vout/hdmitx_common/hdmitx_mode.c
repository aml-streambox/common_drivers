...
static const struct hdmi_timing vesa_modes[] = {
	{HDMIV_0_640x480p60hz, "640x480p60hzV", "640x480p60hz", 1, 26218, 59940, 25175,
		800, 160, 16, 96, 48, 640, 525, 45, 10, 2, 33, 480, 1, 0, 0, 4, 3, 1, 1},
	{HDMIV_1_800x480p60hz, "800x480p60hzV", "800x480p60hz", 1, 30000, 60000, 29760,
		992, 192, 24, 72, 96, 800, 500, 20, 3, 7, 10, 480, 1, 1, 1, 4, 3},
	{HDMIV_2_800x600p60hz, "800x600p60hzV", "800x600p60hz", 1, 37879, 60317, 66666,
		1056, 256, 40, 128, 88, 800, 628, 28, 1, 4, 23, 600, 1, 1, 1, 4, 3},
	{HDMIV_3_852x480p60hz, "852x480p60hzV", "852x480p60hz", 1, 31900, 59960, 30240,
		948, 96, 40, 16, 40, 852, 532, 52, 10, 2, 40, 480, 1, 1, 1, 213, 120},
	{HDMIV_4_854x480p60hz, "854x480p60hzV", "854x480p60hz", 1, 31830, 59950, 30240,
		950, 96, 40, 16, 40, 854, 531, 51, 10, 2, 39, 480, 1, 1, 1, 427, 240},
	{HDMIV_5_1024x600p60hz, "1024x600p60hzV", "1024x600p60hz", 1, 38280, 60000, 51448,
		1344, 320, 24, 136, 160, 1024, 638, 38, 3, 6, 29, 600, 1, 1, 1, 17, 10},
	{HDMIV_6_1024x768p60hz, "1024x768p60hzV", "1024x768p60hz", 1, 48360, 60004, 79500,
		1344, 320, 24, 136, 160, 1024, 806, 38, 3, 6, 29, 768, 1, 1, 1, 4, 3},
	{HDMIV_7_1152x864p75hz, "1152x864p75hzV", "1152x864p75hz", 1, 67500, 75000, 108000,
		1600, 448, 64, 128, 256, 1152, 900, 36, 1, 3, 32, 864, 0, 1, 1, 4, 3},
	{HDMIV_8_1280x768p60hz, "1280x768p60hzV", "1280x768p60hz", 1, 47776, 59870, 79500,
		1664, 384, 64, 128, 192, 1280, 798, 30, 3, 7, 20, 768, 0, 1, 1, 5, 3},
	{HDMIV_9_1280x800p60hz, "1280x800p60hzV", "1280x800p60hz", 1, 49380, 59910, 83500,
		1440, 160, 48, 32, 80, 1280, 823, 23, 3, 6, 14, 800, 1, 1, 1, 8, 5},
	{HDMIV_10_1280x960p60hz, "1280x960p60hzV", "1280x960p60hz", 1, 60000, 60000, 108000,
		1800, 520, 96, 112, 312, 1280, 1000, 40, 1, 3, 36, 960, 0, 1, 1, 4, 3},
	{HDMIV_11_1280x1024p60hz, "1280x1024p60hzV", "1280x1024p60hz", 1, 63981, 60020, 108000,
		1688, 408, 48, 112, 248, 1280, 1066, 42, 1, 3, 38, 1024, 1, 1, 1, 5, 4},
	{HDMIV_12_1360x768p60hz, "1360x768p60hzV", "1360x768p60hz", 1, 47700, 60015, 85500,
		1792, 432, 64, 112, 256, 1360, 795, 27, 3, 6, 18, 768, 1, 1, 1, 16, 9},
	{HDMIV_13_1366x768p60hz, "1366x768p60hzV", "1366x768p60hz", 1, 47880, 59790, 85500,
		1792, 426, 70, 143, 213, 1366, 798, 30, 3, 3, 24, 768, 1, 1, 1, 16, 9},
	{HDMIV_14_1400x1050p60hz, "1400x1050p60hzV", "1400x1050p60hz", 1, 65317, 59978, 121750,
		1862, 464, 88, 144, 232, 1400, 1089, 39, 3, 4, 32, 1050, 1, 1, 1, 4, 3},
	{HDMIV_15_1440x900p60hz, "1440x900p60hzV", "1440x900p60hz", 1, 56040, 59887, 106500,
		1904, 464, 80, 152, 232, 1440, 934, 34, 3, 6, 25, 900, 1, 1, 1, 8, 5},
	{HDMIV_16_1440x2560p60hz, "1440x2560p60hzV", "1440x2560p60hz", 1, 155760, 59999, 244850,
		1572, 132, 64, 4, 64, 1440, 2596, 36, 16, 4, 16, 2560, 1, 1, 1, 16, 9},
	{HDMIV_17_1600x900p60hz, "1600x900p60hzV", "1600x900p60hz", 1, 60000, 60000, 108000,
		1800, 200, 24, 80, 96, 1600, 1000, 100, 1, 3, 96, 900, 1, 1, 1, 16, 9},
	{HDMIV_18_1600x1200p60hz, "1600x1200p60hzV", "1600x1200p60hz", 1, 75000, 60000, 162000,
		2160, 560, 64, 192, 304, 1600, 1250, 50, 1, 3, 46, 1200, 1, 1, 1, 4, 3},
	{HDMIV_19_1680x1050p60hz, "1680x1050p60hzV", "1680x1050p60hz", 1, 65290, 59954, 146250,
		2240, 560, 104, 176, 280, 1680, 1089, 39, 3, 6, 30, 1050, 1, 1, 1, 8, 5},
	{HDMIV_20_1920x1200p60hz, "1920x1200p60hzV", "1920x1200p60hz", 1, 74700, 59885, 193250,
		2592, 672, 136, 200, 336, 1920, 1245, 45, 3, 6, 36, 1200, 1, 1, 1, 8, 5},
	{HDMIV_21_2048x1080p24hz, "2048x1080p24hzV", "2048x1080p24hz", 1, 27000, 24000, 74250,
		2750, 702, 148, 44, 510, 2048, 1125, 45, 4, 5, 36, 1080, 1, 1, 1, 256, 135},
	{HDMIV_22_2160x1200p90hz, "2160x1200p90hzV", "2160x1200p90hz", 1, 109080, 90000, 268550,
		2462, 302, 190, 32, 80, 2160, 1212, 12, 6, 3, 3, 1200, 1, 1, 1, 9, 5},
	{HDMIV_23_2560x1600p60hz, "2560x1600p60hzV", "2560x1600p60hz", 1, 99458, 59987, 348500,
		3504, 944, 192, 280, 472, 2560, 1658, 58, 3, 6, 49, 1600, 1, 1, 1, 8, 5},
	{HDMIV_24_3440x1440p60hz, "3440x1440p60hzV", "3440x1440p60hz", 1, 88819, 59973, 319750,
		3600, 160, 48, 32, 80, 3440, 1481, 41, 3, 10, 28, 1440, 1, 1, 1, 43, 18},
	{HDMIV_25_2400x1200p90hz, "2400x1200p90hzV", "2400x1200p90hz", 1, 112812, 90106, 280000,
		2482, 82, 20, 30, 32, 2400, 1252, 52, 17, 5, 30, 1200, 1, 1, 1, 2, 1},
	{HDMIV_26_3840x1080p60hz, "3840x1080p60hzV", "3840x1080p60hz", 1, 67500, 60000, 297000,
		4400, 560, 176, 88, 296, 3840, 1125, 45, 4, 5, 36, 1080, 1, 1, 1, 32, 6},
	{HDMIV_27_2560x1440p60hz, "2560x1440p60hzV", "2560x1440p60hz", 1, 88787, 59951, 241500,
		2720, 160, 48, 32, 80, 2560, 1481, 41, 3, 5, 33, 1440, 1, 1, 1, 16, 9},
	{HDMIV_28_2560x1440p120hz, "2560x1440p120hzV", "2560x1440p120hz", 1, 183011, 119991, 497750,
		2720, 160, 48, 32, 80, 2560, 1525, 85, 3, 5, 77, 1440, 1, 1, 1, 16, 9},
	{HDMIV_29_2560x1440p144hz, "2560x1440p144hzV", "2560x1440p144hz", 1, 209942, 143993, 571040,
		2720, 160, 48, 32, 80, 2560, 1458, 18, 3, 5, 10, 1440, 1, 1, 1, 16, 9},
	{HDMIV_30_1920x1080p144hz, "1920x1080p144hzV", "1080p144hz", 1, 161971, 143920, 356340,
		2200, 280, 88, 44, 148, 1920, 1125, 45, 4, 5, 36, 1080, 1, 1, 1, 16, 9},
	{HDMIV_31_1920x1080p240hz, "1920x1080p240hzV", "1080p240hz", 1, 270000, 240000, 594000,
		2200, 280, 88, 44, 148, 1920, 1125, 45, 4, 5, 36, 1080, 1, 1, 1, 16, 9},
};
...
/* Relaxed DTD matching for VESA modes: match by resolution + approximate
 * refresh rate (within ±3Hz). Used as a fallback when exact DTD parameter
 * matching fails, e.g. when a monitor uses slightly different blanking
 * intervals than our vesa_modes[] table entries.
 */
